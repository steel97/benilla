...
pub(crate) type RoomPlacements<'w, 's> = Query<'w, 's, &'static WmoPortalInstance>;
...
pub(crate) fn player_claim(room: &PlayerWmoRoom, placements: &RoomPlacements) -> LiquidClaim {
    match room.0 {
...
pub(crate) fn unit_claim(room: Option<&UnitWmoRoom>, placements: &RoomPlacements) -> LiquidClaim {
