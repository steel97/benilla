...
pub(crate) struct WorldProj {
    pub(crate) offset_u: f32,
...
pub(crate) fn world_uv(proj: WorldProj, wx: f32, wy: f32) -> (f32, f32) {
...
pub(crate) fn zone_uv(rect: ZoneRect, wx: f32, wy: f32) -> (f32, f32) {
...
pub(crate) fn continent_sheet_rect(
