...
pub(crate) struct WeatherState {
    ...
    pub(crate) effect_kind: WeatherKind,
    intensity: Channel,
    sky: Channel,
...
pub(crate) fn storm_blend(sky_density: f32) -> f32 {
